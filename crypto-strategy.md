...
**Take Profit (in order of priority):**
1. **Climax** — parabolic extension, volume spikes (take most profit)
2. **+15%** — conservative target
3. **Test failed** — price rallies but makes lower high (exit)

**Stop Loss:**
- **-5%** hard stop

**Trailing Exit:**
- If price pulls back to breakout level = exit or reduce position

**Key Livermore Exit Patterns:**
- Lower high after advance = trend reversing
- Volume drying up on advance = exhaustion
- Wide-range decline days = distribution starting

### 4. Position Sizing - Dynamic (Win/Loss Scaling)
...
|--------|-------------------|
| WIN (+15% or more) | +50% (15% of portfolio) |
| WIN (5-15%) | +25% (12.5% of portfolio) |
| WIN (<5%) | Same (10% of portfolio) |
| LOSE | -50% (5% of portfolio) |
